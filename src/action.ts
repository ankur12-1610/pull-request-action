...
async function run() {
    ...
    if(prs_by_author_count > 1) {
      core.setOutput('PR_REACTION', PR_REACTION)
      core.setOutput('COMMENT_TEXT', COMMENT_TEXT + gif)
      core.setOutput('TAG_AUTHOR', tag_text)
      core.setOutput('ASSIGN_TO_AUTHOR', assignee)
      core.setOutput('FIRST_TIMERS_MESSAGE', null)
    } else {
      core.setOutput('PR_REACTION', null)
      core.setOutput('COMMENT_TEXT', null)
      core.setOutput('TAG_AUTHOR', null)
      core.setOutput('ASSIGN_TO_AUTHOR', null)
      core.setOutput('FIRST_TIMERS_MESSAGE', FIRST_TIMERS_MESSAGE)
    }
